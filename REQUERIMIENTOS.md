...
* El cliente puede revisar y diligenciar el checkout sin sesión, pero al confirmar el pago se le exige iniciar sesión o registrarse; no se permite crear pedidos como invitado.[cite: 1]
